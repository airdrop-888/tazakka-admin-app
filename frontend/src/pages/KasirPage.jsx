// frontend/src/pages/KasirPage.jsx (KODE LENGKAP - DENGAN CUSTOM SUCCESS MODAL)
    ...
    <div className="modal-overlay-success">
      <div className="modal-content-success">
        ...
        <div className="success-actions">
          <button className="btn-success-cancel" onClick={onClose}>Tutup</button>
          <button className="btn-success-confirm" onClick={onConfirm}>Cetak Struk</button>
        </div>
      </div>
    </div>
  );
...
const KasirPage = ({ token }) => {
  ...
  // --- PERBAIKAN 2: State untuk modal baru ---
  const [showSuccessModal, setShowSuccessModal] = useState(false);

  // Fungsi lainnya (handleAddToCart, dll) tidak berubah
  ...
  const handleCheckout = async () => {
    ...
    const transactionPromises = cart.map(item => {
      ...
      return axios.post('http://127.0.0.1:8000/transactions/', transactionData, {
    ...
    try {
      ...
      // --- PERBAIKAN 3: Tampilkan modal baru, bukan window.confirm ---
  ...
  return (
    <div className="kasir-layout">
      {/* --- PERBAIKAN 4: Tambahkan modal ke dalam render --- */}
      <SuccessModal
        ...
        onConfirm={() => {
          alert("Fungsi cetak struk sedang dalam pengembangan.");
          setShowSuccessModal(false);
          resetTransaction();
        }}
      />
      ...
      <main className="kasir-main-wrapper">
         {/* ... Sisa JSX main wrapper tidak berubah ... */}
      ...
      <aside className="kasir-sidebar">
        {/* ... Sisa JSX sidebar tidak berubah ... */}
        <div className="sidebar-header-section">
          ...
          <div className="sidebar-info-section">
            ...
            <div className="info-input-group">
              <FiTool />
              <input type="text" placeholder="Nama Teknisi (Opsional)" value={technicianName} onChange={e => setTechnicianName(e.target.value)} />
            </div>
          </div>
        </div>
              ...
              : cart.map(item => (
                  <div key={item.id} className="cart-item">
                    <div className="item-details">
                      ...
                      <p className="item-price">{formatToRupiah(item.price)}</p>
                    </div>
        ...
        <div className="sidebar-footer">
          ...
          <div className="payment-section">
            ...
            <select value={paymentMethod} onChange={e => setPaymentMethod(e.target.value)}>
              <option>Tunai</option><option>Transfer BCA</option><option>Transfer BSI</option><option>QRIS</option>
            </select>
            <label>Jumlah Bayar</label>
            <div className="payment-controls">
                <input type="text" placeholder="Rp 0" value={amountPaid} onChange={e => setAmountPaid(formatToRupiah(parseRupiah(e.target.value)))} />
                <button className="quick-cash-btn" onClick={() => setAmountPaid(formatToRupiah(summary.total))}>Uang Pas</button>
            </div>
          </div>
          <div className="change-display">
            <span>Kembalian</span>
            <span>{summary.change >= 0 ? formatToRupiah(summary.change) : '-'}</span>
          </div>
          {error && <p className="error">{error}</p>}
          <button className="checkout-button" onClick={handleCheckout} disabled={isSaving || cart.length === 0}>
            {isSaving ? 'Memproses...' : 'Selesaikan Transaksi'}
          </button>
        </div>
      </aside>
    </div>
...
const initialProductList = [
    { id: 10, name: 'Upgrade SSD - Paket Premium', device_category: 'Laptop', part_category: 'Paket Upgrade - Premium', price: 750000, cost: 0 },
    { id: 11, name: 'Upgrade SSD - Paket Basic', device_category: 'Laptop', part_category: 'Paket Upgrade - Basic', price: 500000, cost: 0 },
    { id: 12, name: 'Papan Charger Biasa', device_category: 'Hape', part_category: 'Papan Charger', price: 125000, cost: 0 },
    { id: 13, name: 'Papan Charger Ori', device_category: 'Hape', part_category: 'Papan Charger', price: 150000, cost: 0 },
    { id: 1, name: 'Ganti LCD STANDAR', device_category: 'Hape', part_category: 'LCD', price: 350000, cost: 0 },
    { id: 2, name: 'Ganti Baterai STANDAR', device_category: 'Hape', part_category: 'Battery', price: 200000, cost: 0 },
	{ id: 23, name: 'Ganti Baterai ORI', device_category: 'Hape', part_category: 'Battery', price: 250000, cost: 0 },
    { id: 3, name: 'Install Ulang Windows 11', device_category: 'Laptop', part_category: 'Software', price: 150000, cost: 0 },
    { id: 4, name: 'Cleaning & Repasta', device_category: 'Laptop', part_category: 'Cleaning, Repasta', price: 100000, cost: 0 },
    { id: 5, name: 'Ganti Keyboard Lenovo Ideapad', device_category: 'Laptop', part_category: 'Keyboard', price: 350000, cost: 0 },
    { id: 6, name: 'Reset Printer Epson L3110', device_category: 'Printer', part_category: 'Reset', price: 75000, cost: 0 },
    { id: 7, name: 'Jasa Pengecekan', device_category: 'Hape', part_category: 'Pengecekan', price: 50000, cost: 0 },
	{ id: 24, name: 'Jasa Pengecekan', device_category: 'Hape', part_category: 'Pengecekan', price: 75000, cost: 0 },
    { id: 8, name: 'Cartridge Tinta Hitam', device_category: 'Printer', part_category: 'Cartridge Hitam', price: 225000, cost: 0 },
    { id: 9, name: 'Software Remove Virus', device_category: 'Hape', part_category: 'Remove Virus', price: 75000, cost: 0 },
	{ id: 14, name: 'Upgrade SSD - Paket Exlusive', device_category: 'Laptop', part_category: '', price: 1050000, cost: 0 },
	{ id: 15, name: 'Install Ulang Win 10 - Cracked', device_category: 'Laptop', part_category: '', price: 150000, cost: 0 },
	{ id: 16, name: 'Install Ulang Win 11 - Cracked', device_category: 'Laptop', part_category: '', price: 150000, cost: 0 },
	{ id: 17, name: 'Install Ulang Win 10 - Ori', device_category: 'Laptop', part_category: '', price: 350000, cost: 0 },
	{ id: 18, name: 'Install Ulang Win 11 - Ori', device_category: 'Laptop', part_category: '', price: 350000, cost: 0 },
	{ id: 19, name: 'Install Ulang Win 10 - Ori', device_category: 'Laptop', part_category: '', price: 350000, cost: 0 },
	{ id: 20, name: 'Install Ulang Win 10 - Ori', device_category: 'Laptop', part_category: '', price: 350000, cost: 0 },
	{ id: 21, name: 'Install Ulang Win 10 - Ori', device_category: 'Laptop', part_category: '', price: 350000, cost: 0 },
	{ id: 22, name: 'Install Ulang Win 10 - Ori', device_category: 'Laptop', part_category: '', price: 350000, cost: 0 },
];
